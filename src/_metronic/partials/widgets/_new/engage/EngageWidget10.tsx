...
const EngageWidget10 = ({className}: Props) => (
  <div className={`card card-flush ${className}`}>
    <div
      ...
      style={{ backgroundPosition: '100% 50%', backgroundImage: `url('${toAbsoluteUrl('/media/stock/900x600/42.png')}')`,   }} >
      <div className='mb-10'>
        <div className='fs-2hx fw-bold text-gray-800 text-center mb-13'>
          <span className='me-2'>
            ...
            <span className='position-relative d-inline-block text-danger'>
              <Link  to='/crafted/pages/profile/overview'  className='text-danger opacity-75-hover'   >
                Pro Plan
              </Link>
