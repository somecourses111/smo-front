...
export const AddCountries = () => {
  ...
  const handleEdit_Add_submit = async (event) => {
    ...
    try {
      await axiosInstance.post(`/admin-countries`, formData).then(response => {
        Swal.fire({
          title: "Success",
          icon: "success",
    ...
    <motion.nav
      ...
      <div className=" mb-5 mt-5 d-flex flex-stack">
        <div className="page-title d-flex flex-column justify-content-center flex-wrap me-3">
          <h1 className="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">{intl.formatMessage({ id: 'Country.Create' })}</h1>
